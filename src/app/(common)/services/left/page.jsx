...
import { FaAngleDown, FaAngleRight, FaCheck, FaChevronRight, FaFacebookF, FaInstagram, FaLinkedinIn, FaMagnifyingGlass } from "react-icons/fa6";
                                    ...
                                    <div className="ca-servic-thumb-content">
                                        ...
                                        <div className="ca-acordion-area home-faq">
                                            <Accordion defaultActiveKey={'0'} className="accordion" id="accordionExample">
                                                {faqData.map((faq, idx) => <AccordionItem eventKey={idx.toString()} key={faq.id} className="ca-accordion-item ca-accordion-item-2 mb-24">
