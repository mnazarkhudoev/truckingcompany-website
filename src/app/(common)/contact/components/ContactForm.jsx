...
const ContactForm = () => {
  ...
  return <Form onSubmit={handleSubmit}>
            <Row>
                ...
                <Col lg={6} className="mb-20">
                    <Form.Control as="select" className="nice-select wide ca-select">
                ...
                <Col lg={12} className="mb-20">
                    <Form.Control as="textarea" name="message" placeholder="Message" value={formData.message} onChange={handleChange} />
                </Col>
            </Row>
